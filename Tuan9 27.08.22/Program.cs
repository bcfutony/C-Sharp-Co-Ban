...
namespace Tuan9_27._08._22
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //bai 43
            Console.WriteLine($"bai 43 so luong chu so cua so nguyen duong {n}: {Bai_43(n)}");
            //bai 44
            Console.WriteLine($"bai 44 tong cac chu so cua so nguyen duong {n}: {Bai_44(n)}");
            //bai 46
            Console.WriteLine($"bai 46 so luong so le cua so nguyen duong {n}: {Bai_46(n)}");
            //bai 50
            Console.WriteLine($"bai 50 so dao cua so nguyen duong {n}: {Bai_50(n)}");
        }
    }
}
